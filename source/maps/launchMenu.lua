function launchMenu()
    ...
    table.insert(tutorial_elements, Text(params.winWidth/2, 500, "Bird Behaviour Handbook, pp 26: 'Birds prefer flying between large trees. When approached by humans they can become frightened'.", 1, txtCol, buttonCol))
